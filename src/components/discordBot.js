...
module.exports = class DiscordBot {
    ...
    async handleMessage(message){
        ...
        }else if(message.content.startsWith('/LionPanel')){
            //Prepare object
            out = new Discord.RichEmbed();
            out.setTitle(`${globals.config.serverName} uses LionPanel v${globals.version.current}!`);
            out.setColor(0x4DEEEA);
            out.setDescription(`Checkout the project:\n GitHub: https://github.com/tabarra/LionPanel\n Discord: https://discord.gg/f3TsfvD`);
