...
module.exports = class ConsoleBuffer {
    ...
    write(data, markType) {
        ...
        try {
            ...
            //This regex was done in the first place to prevent fxserver output to be interpreted as LionPanel output by the host terminal
            //IIRC the issue was that one user with a TM on their nick was making LionPanel's console to close or freeze. I couldn't reproduce the issue.
