...
module.exports = async () => {
    try {
        ...
        let ver = '9.9.9';
        let msg = `Error checking for updates, if this error persists for more than 4 hours, <br> you probably need to update. <br> This is likely an issue with your server's internet or GitHub.  <br> Check out our <a href="https://discord.gg/Zyemy27" target="_blank" class="alert-link">Discord Server</a> for more information.`;
