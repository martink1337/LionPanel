...
const LionPanel = require('./LionPanel.js');
...
//==============================================================
//Print MOTD
let ascii = helpers.LionPanelASCII()
...
const app = new LionPanel(serverProfile);
...
setInterval(() => {
    ...
    if(now - hdTimer > 2000){
        ...
        setTimeout(() => {
            ...
            logError('THIS IS NOT AN ERROR CAUSED BY LIONSQUAD PANEL! Your VPS might be lagging out.');
            logError(sep);
        }, 1000);
    }
    hdTimer = now;
