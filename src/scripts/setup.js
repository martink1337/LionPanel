...
(async () => {
    ...
    console.log("> What TCP port should LionPanel use to host the web panel?");
    ...
    logOk(`To start LionPanel with this profile run: ${cmd}`, context);
    if(!isLinux){
        let cmd2 = ac.inverse(` LionPanel/start_${serverProfile}.bat `);
