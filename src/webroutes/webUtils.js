...
async function renderMasterView(view, reqSess, data){
    ...
    data.headerTitle = (!isUndefined(data.headerTitle))? `${data.headerTitle} - LionPanel` : 'LionPanel';
    data.LionPanelVersion = globals.version.current;
